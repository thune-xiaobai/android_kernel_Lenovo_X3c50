...
/*inorder to keep low power for Fll open to improve audio route time ,disable enable tone and try to keep dapm running only*/
SND_SOC_DAPM_PGA("Tone Generator 1", SND_SOC_NOPM,
		 0, 0, NULL, 0),
...
SND_SOC_DAPM_AIF_OUT("AIF2TX3", "AIF2 Capture", 0,
		     ARIZONA_AIF2_TX_ENABLES, ARIZONA_AIF2TX3_ENA_SHIFT, 0),
SND_SOC_DAPM_AIF_OUT("AIF2TX4", "AIF2 Capture", 0,
		     ARIZONA_AIF2_TX_ENABLES, ARIZONA_AIF2TX4_ENA_SHIFT, 0),
SND_SOC_DAPM_AIF_OUT("AIF2TX5", "AIF2 Capture", 0,
		     ARIZONA_AIF2_TX_ENABLES, ARIZONA_AIF2TX5_ENA_SHIFT, 0),
SND_SOC_DAPM_AIF_OUT("AIF2TX6", "AIF2 Capture", 0,
...
SND_SOC_DAPM_AIF_IN("AIF2RX3", "AIF2 Playback", 0,
		    ARIZONA_AIF2_RX_ENABLES, ARIZONA_AIF2RX3_ENA_SHIFT, 0),
SND_SOC_DAPM_AIF_IN("AIF2RX4", "AIF2 Playback", 0,
		    ARIZONA_AIF2_RX_ENABLES, ARIZONA_AIF2RX4_ENA_SHIFT, 0),
SND_SOC_DAPM_AIF_IN("AIF2RX5", "AIF2 Playback", 0,
		    ARIZONA_AIF2_RX_ENABLES, ARIZONA_AIF2RX5_ENA_SHIFT, 0),
SND_SOC_DAPM_AIF_IN("AIF2RX6", "AIF2 Playback", 0,
...
SND_SOC_DAPM_AIF_OUT_E("SLIMTX5", "Slim2 Capture", 0,
		     ...
		     arizona_slim_tx_ev,
		     SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_OUT_E("SLIMTX6", "Slim2 Capture", 0,
		     ARIZONA_SLIMBUS_TX_CHANNEL_ENABLE,
		     ARIZONA_SLIMTX6_ENA_SHIFT, 0,
		     arizona_slim_tx_ev,
		     SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_OUT_E("SLIMTX7", "Slim3 Capture", 0,
		     ARIZONA_SLIMBUS_TX_CHANNEL_ENABLE,
		     ARIZONA_SLIMTX7_ENA_SHIFT, 0,
		     arizona_slim_tx_ev,
		     SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
SND_SOC_DAPM_AIF_OUT_E("SLIMTX8", "Slim3 Capture", 0,
		     ARIZONA_SLIMBUS_TX_CHANNEL_ENABLE,
