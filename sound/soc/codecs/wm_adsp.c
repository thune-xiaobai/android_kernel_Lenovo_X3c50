...
static bool use_default_trigger_word = 0;
...
#define WM_ADSP_FW_EZ2HEAR_SPEAKER_TX    9
#define WM_ADSP_FW_EZ2HEAR_HANDSET_TX	10
#define WM_ADSP_FW_EZ2HEAR_HEADSET_TX   11
#define WM_ADSP_FW_EZ2HEAR_SPEAKER_RX   12
#define WM_ADSP_FW_EZ2HEAR_HANDSET_RX   13
#define WM_ADSP_FW_EZ2HEAR_HEADSET_RX   14
#define WM_ADSP_FW_EZ2FACETALK_TX 15
#define WM_ADSP_FW_EZ2FACETALK_RX 16
#define WM_ADSP_FW_EZ2GROUPTALK_TX 17
#define WM_ADSP_FW_EZ2GROUPTALK_RX 18
#define WM_ADSP_FW_EZ2RECORD       19
#define WM_ADSP_FW_ASR_ASSIST     20
#define WM_ADSP_FW_MASTERHIFI     21
#define WM_ADSP_FW_SPEAKERPROTECT 22
#define WM_ADSP_FW_KARAOKE_VOCALS 23
#define WM_ADSP_FW_KARAOKE_MUSIC  24
#define WM_ADSP_FW_EZ2HEAR_HEADPHONE_TX 25
#define WM_ADSP_FW_EZ2HEAR_HEADPHONE_RX 26
/*Add VOIP Setting */
#define WM_ADSP_FW_EZ2HEAR_VOIP_SPEAKER_TX    27
#define WM_ADSP_FW_EZ2HEAR_VOIP_HANDSET_TX	  28
#define WM_ADSP_FW_EZ2HEAR_VOIP_HEADSET_TX    29
#define WM_ADSP_FW_EZ2HEAR_VOIP_SPEAKER_RX    30
#define WM_ADSP_FW_EZ2HEAR_VOIP_HANDSET_RX   31
#define WM_ADSP_FW_EZ2HEAR_VOIP_HEADSET_RX   32
#define WM_ADSP_FW_EZ2HEAR_VOIP_HEADPHONE_TX 33
#define WM_ADSP_FW_EZ2HEAR_VOIP_HEADPHONE_RX 34
#define WM_ADSP_NUM_FW            35
...
static const char *wm_adsp_fw_text[WM_ADSP_NUM_FW] = {
	...
	[WM_ADSP_FW_EZ2HEAR_SPEAKER_TX] = "Ez2HearSpeaker Tx",
	[WM_ADSP_FW_EZ2HEAR_HANDSET_TX] = "Ez2HearHandset Tx",
	[WM_ADSP_FW_EZ2HEAR_HEADSET_TX] = "Ez2HearHeadset Tx",
	[WM_ADSP_FW_EZ2HEAR_SPEAKER_RX] = "Ez2HearSpeaker Rx",
	[WM_ADSP_FW_EZ2HEAR_HANDSET_RX] = "Ez2HearHandset Rx",
	[WM_ADSP_FW_EZ2HEAR_HEADSET_RX] = "Ez2HearHeadset Rx",
	...
	[WM_ADSP_FW_KARAOKE_VOCALS] = "KaraokeVocals",
	[WM_ADSP_FW_KARAOKE_MUSIC] = "KaraokeMusic",
	[WM_ADSP_FW_EZ2HEAR_HEADPHONE_TX] = "Ez2HearHeadphone Tx",	
	[WM_ADSP_FW_EZ2HEAR_HEADPHONE_RX] = "Ez2HearHeadphone Rx",
/*Add VOIP Setting*/
	[WM_ADSP_FW_EZ2HEAR_VOIP_SPEAKER_TX] = "Ez2HearVoipSpeaker Tx",
	[WM_ADSP_FW_EZ2HEAR_VOIP_HANDSET_TX] = "Ez2HearVoipHandset Tx",
	[WM_ADSP_FW_EZ2HEAR_VOIP_HEADSET_TX] = "Ez2HearVoipHeadset Tx",
	[WM_ADSP_FW_EZ2HEAR_VOIP_SPEAKER_RX] = "Ez2HearVoipSpeaker Rx",
	[WM_ADSP_FW_EZ2HEAR_VOIP_HANDSET_RX] = "Ez2HearVoipHandset Rx",
	[WM_ADSP_FW_EZ2HEAR_VOIP_HEADSET_RX] = "Ez2HearVoipHeadset Rx",
	[WM_ADSP_FW_EZ2HEAR_VOIP_HEADPHONE_TX] = "Ez2HearVoipHeadphone Tx",
	[WM_ADSP_FW_EZ2HEAR_VOIP_HEADPHONE_RX] = "Ez2HearVoipHeadphone Rx",
};
...
static struct wm_adsp_fw_defs wm_adsp_fw[WM_ADSP_NUM_FW] = {
	...
	[WM_ADSP_FW_EZ2HEAR_SPEAKER_TX] = { .file = "ez2hear-sp-tx", .binfile = "ez2hear-tx-speaker"},
	[WM_ADSP_FW_EZ2HEAR_HANDSET_TX] = { .file = "ez2hear-hs-tx", .binfile = "ez2hear-tx-handset"},
	[WM_ADSP_FW_EZ2HEAR_HEADSET_TX] = { .file = "ez2hear-hs-tx", .binfile = "ez2hear-tx-headset"},
	[WM_ADSP_FW_EZ2HEAR_SPEAKER_RX] = { .file = "ez2hear-rx", .binfile = "ez2hear-rx-speaker" },
	[WM_ADSP_FW_EZ2HEAR_HANDSET_RX] = { .file = "ez2hear-rx", .binfile = "ez2hear-rx-handset"},
	[WM_ADSP_FW_EZ2HEAR_HEADSET_RX] = { .file = "ez2hear-rx", .binfile = "ez2hear-rx-headset"},
	...
	[WM_ADSP_FW_EZ2RECORD] = { .file = "ez2record", .binfile = "ez2record-handset" },
	[WM_ADSP_FW_ASR_ASSIST] =     { .file = "asr-assist" },
	[WM_ADSP_FW_MASTERHIFI] =     { .file = "masterhifi" },
	[WM_ADSP_FW_SPEAKERPROTECT] = { .file = "speaker-protect" },
	[WM_ADSP_FW_KARAOKE_VOCALS] = { .file = "karaoke-vocals" },
	[WM_ADSP_FW_KARAOKE_MUSIC] = { .file = "karaoke-music" },
	[WM_ADSP_FW_EZ2HEAR_HEADPHONE_TX] = { .file = "ez2hear-hs-tx", .binfile = "ez2hear-tx-headphone"},
	[WM_ADSP_FW_EZ2HEAR_HEADPHONE_RX] = { .file = "ez2hear-rx", .binfile = "ez2hear-rx-headphone"},
/*Add VOIP Setting*/
	[WM_ADSP_FW_EZ2HEAR_VOIP_SPEAKER_TX] = { .file = "ez2hear-sp-tx", .binfile = "ez2hear-voip-tx-speaker"},
	[WM_ADSP_FW_EZ2HEAR_VOIP_HANDSET_TX] = { .file = "ez2hear-hs-tx", .binfile = "ez2hear-voip-tx-handset"},
	[WM_ADSP_FW_EZ2HEAR_VOIP_HEADSET_TX] = { .file = "ez2hear-hs-tx", .binfile = "ez2hear-voip-tx-headset"},
	[WM_ADSP_FW_EZ2HEAR_VOIP_SPEAKER_RX] = { .file = "ez2hear-rx", .binfile = "ez2hear-voip-rx-speaker" },
	[WM_ADSP_FW_EZ2HEAR_VOIP_HANDSET_RX] = { .file = "ez2hear-rx", .binfile = "ez2hear-voip-rx-handset"},
	[WM_ADSP_FW_EZ2HEAR_VOIP_HEADSET_RX] = { .file = "ez2hear-rx", .binfile = "ez2hear-voip-rx-headset"},
	[WM_ADSP_FW_EZ2HEAR_VOIP_HEADPHONE_TX] = { .file = "ez2hear-hs-tx", .binfile = "ez2hear-voip-tx-headphone"},
	[WM_ADSP_FW_EZ2HEAR_VOIP_HEADPHONE_RX] = { .file = "ez2hear-rx", .binfile = "ez2hear-voip-rx-headphone"},
};
...
static int florida_trigger_mode_get(struct snd_kcontrol *kcontrol,
			       struct snd_ctl_elem_value *ucontrol)
{
        ucontrol->value.integer.value[0] = use_default_trigger_word; 
        pr_info("%s trigger mode %s",__func__, use_default_trigger_word?"default":"custom");
	return 0;
}

static int florida_trigger_mode_put(struct snd_kcontrol *kcontrol,
			       struct snd_ctl_elem_value *ucontrol)
{
        use_default_trigger_word =  ucontrol->value.integer.value[0];
        pr_info("%s trigger mode %s",__func__, use_default_trigger_word?"default":"custom");
	return 0;
}
...
const struct snd_kcontrol_new wm_adsp2_fw_controls[] = {
	...
	SOC_SINGLE_EXT("TRIGGER_USE_DEFAULT", SND_SOC_NOPM, 0, 1, 0,
		     florida_trigger_mode_get, florida_trigger_mode_put),
};
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	if (!(ctl->cache_init)) {
		if (ctl->enabled) {
			ret = wm_coeff_read_control(kcontrol, ctl->cache, ctl->len);
			if (ret == 0)
				ctl->cache_init = 1;
		}
	}
...
static int wm_adsp_load(struct wm_adsp *dsp)
{
	...
	adsp_info(dsp, "%s.load completed!!cost %lu ms\n", file, jiffies_to_msecs(jiffies)-starttimejiffies);
out_buf:
...
static int wm_adsp_load_coeff(struct wm_adsp *dsp)
{
	...
	int tmp;
        ...
        if (dsp->fw == WM_ADSP_FW_EZ2CONTROL && use_default_trigger_word)
        {
            adsp_warn(dsp, "app told to use default, do not load bin file\n");
            return 0;
        }
...
/*Then check id register to check spi ARIZONA_SOFTWARE_RESET*/
             val = 0;
             regmap_read(dsp->regmap, ARIZONA_SOFTWARE_RESET, &val);
             adsp_err(dsp, "wm_adsp2_ena check registers chipId val=%x\n",val);

 /*Then check id register to check spi ARIZONA_SOFTWARE_RESET*/
             val = 0;
             regmap_read(dsp->regmap, ARIZONA_DEVICE_REVISION, &val);
             adsp_err(dsp,"wm_adsp2_ena check registers chip version val=%x\n",val);
