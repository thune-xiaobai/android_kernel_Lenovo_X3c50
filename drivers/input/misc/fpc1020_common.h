...
/*[KLASSEN,shaojc2,KLASSEN-898,add sysfs interface for spi secure transfer and unsecure transfer switch],add*/
	u32 set_secure_transfer; /*RW*/
/*[KLASSEN,shaojc2,KLASSEN-898,add sysfs interface for spi secure transfer and unsecure transfer switch],add end*/
	u8  fpc_id;	/* RO */
	u32 irq_event_enable; /*RW*/
	u32 pid;
	u32 work_mode;
	u32 sig_no;
	u32 irq_pin_level;
