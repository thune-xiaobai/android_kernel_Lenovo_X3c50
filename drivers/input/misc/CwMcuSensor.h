...
#ifdef TOUCH
#define     STD_DRIVER_ID_END   TOUCH
...
typedef enum {
    ...
    */
    ...
    //IR send
    RegMapW_IR_SendInfo     = 0xE0, //6 bytes
    RegMapW_IR_SendData     = 0xE1, //128 bytes, (1~n) times
    RegMapW_IR_SendGo       = 0xE2, //1 byte: 0=>none, 1=>Go
    RegMapR_IR_SendGoStatus = 0xE3, //1 byte: 1=>transfer is completed, 0=>not ready
                                     
    //IR Learning
    RegMapR_IR_LearnEnable  = 0xE4,
    RegMapR_IR_LearnStatus  = 0xE5,
    RegMapR_IR_LearnGetInfo = 0xE6,
    RegMapR_IR_LearnGetData = 0xE7,
	
	/* Only for PEEL test, IR Learning for X3 */
    RegMapW_PEELSendIRData                    = 0xF0,
    RegMapW_PEELSendIRGo                      = 0xF1,
    RegMapW_PEELIRLearnEn                     = 0xF2,
    RegMapW_PEELSendIRSTOP                    = 0xF3,
    
    RegMapR_PEELIRLearnStatus                 = 0xF4,
    RegMapR_PEELIRLearnGetData                = 0xF5,
