...
/* driver constants							*/
/* -------------------------------------------------------------------- */
#define FPC1020_KEY_FINGER_PRESENT	KEY_FINGER_PRESENT	/* 730*/
#define FPC1020_KEY_CAMERA 		KEY_CAMERA		/* 212*/
#define FPC1020_KEY_FINGER_VERIFIED_OK 	KEY_FINGER_VERIFIED_OK 	/* 735*/
#define FPC1020_KEY_FINGER_VERIFIED_FAILED 	KEY_FINGER_VERIFIED_FAILED 	/* 736*/
...
int __devinit fpc1020_input_init(fpc1020_data_t *fpc1020)
{
	...
	if (!error) {
		...
		set_bit(FPC1020_KEY_FINGER_VERIFIED_OK, fpc1020->input_dev->keybit);
		set_bit(FPC1020_KEY_FINGER_VERIFIED_FAILED, fpc1020->input_dev->keybit);
